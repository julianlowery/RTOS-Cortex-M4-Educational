...
typedef enum { RUNNING = 0, READY = 1, BLOCKED = 2, TERMINATED = 3, INNACTIVE = 4 } task_state_t;

typedef enum { HIGHEST, HIGH, MED_HIGH, MEDIUM, MED_LOW, LOW, LOWEST, IDLE } priority_t;
